...
public:
	...
	void setWholeValue(int wv) { wholeValue = wv; }
	void setFractionalValue(int fv) { fractionalValue = fv; }

	string getWholeName() { return currencyName; }
	string getFractionalName() { return fractionalName; }
	int getWholeValue() { return wholeValue; }
	int getFractionalValue() { return fractionalValue; }
